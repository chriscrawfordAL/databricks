...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-chris_crawford` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0122-165305-2gttl9df/configuration)). <br />
...
VECTOR_SEARCH_ENDPOINT_NAME="shared-demo-endpoint"
...
print(chain.invoke({"question": "Do I need to use all of my PTO before I can be on long term disability during fmla?"}))
...
Your are a Human Resources chatbot for Pennsylvania School Boards Association (PSBA). Please answer Human Resources question only. If you don't know or not related to Human Resources, don't answer.
...
print(chain_with_history.invoke({
    "messages": [
        {"role": "user", "content": "Do I need to use all of my PTO before I can be on long term disability during fmla?"}, 
        {"role": "assistant", "content": "No, you do not need to use all of your PTO before being eligible for long-term disability during FMLA. FMLA allows eligible employees to take up to 12 weeks of unpaid leave for certain family and medical reasons, including their own serious health condition. Long-term disability benefits, on the other hand, are typically provided through an employer's insurance plan and are designed to provide income replacement for employees who are unable to work due to a disability that is expected to last for an extended period of time. While some employers may require employees to exhaust their PTO before applying for long-term disability, this is not a universal requirement and may vary depending on the specific policies and procedures of your employer. It's best to check with your HR representative or supervisor to determine the specific requirements and procedures for requesting long-term disability benefits while on FMLA leave."}, 
        {"role": "user", "content": "How do I find my HR representative?"}
    ]
}))
...
# MAGIC %md 
# MAGIC ## Let's add a filter on top to only answer HR-related questions.
# MAGIC
# MAGIC We want our chatbot to be profesionnal and only answer questions related to HR. Let's create a small chain and add a first classification step. 
# MAGIC
