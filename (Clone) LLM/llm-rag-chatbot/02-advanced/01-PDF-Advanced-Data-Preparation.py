...
!ls -al /Volumes/uc_demos_chris_crawford/llm_schema/volume_databricks_documentation/databricks-pdf/

# COMMAND ----------

# /Volumes/uc_demos_chris_crawford/llm_schema/volume_databricks_documentation
...
# MAGIC %sql SELECT * FROM pdf_raw LIMIT 10
...
VECTOR_SEARCH_ENDPOINT_NAME="dbdemos_ccrawford_vs_endpoint"
...
question = "Do I need to use all of my PTO before I can be on long term disability during fmla?"
